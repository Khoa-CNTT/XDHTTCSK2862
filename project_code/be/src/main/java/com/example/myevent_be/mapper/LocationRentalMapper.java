...
public interface LocationRentalMapper {
    ...
    @Mapping(source = "location.name", target = "address", nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
    ...
    LocationRentalResponse toSerivceRentalResponse(LocationRental serviceRental);
