...
//         var eventType = eventTypes.find(type => type.id === event.eventType_id);
...
//                 .then(() => {
//                     console.log("Tạo rental và các dữ liệu liên quan thành công!");
//                     window.location.href = "table-event.html";
//                 })
//                 .catch(error => {
//                     console.error("Lỗi khi tạo rental hoặc dữ liệu liên quan:", error);
//                     toastr.error("Có lỗi xảy ra khi tạo sự kiện. Vui lòng kiểm tra lại!", "Lỗi");
//                 });
//         });
//     };
// }
...
//                 document.querySelector('select[name="eventype"]').value = event.eventType_id;
...
//         createRental(rentalData, async function (rentalResponse) {
...
//                 ]);
//                 console.log("Tất cả device_rental, service_rental, timeline đã được tạo!");
//                 resolve();
//             } catch (error) {
//                 console.error("Lỗi khi tạo device_rental, service_rental, hoặc timeline:", error);
//                 reject(error);
//             }
//         });
//     });
...
//         console.log("Device ID:", deviceId, "Quantity:", quantity);
...
//                         resolve();
//                     } else {
//                         reject(new Error("Failed to create device rental"));
//                     }
//                 });
//             });
//         }
...
//     const serviceRows = document.querySelectorAll("#serviceTable tbody tr");
//     const promises = Array.from(serviceRows).map(row => {
//         const serviceId = row.querySelector('select[name="servicetype"]').value;
//         const quantity = row.querySelector('input[name="quantity"]').value;
//         console.log("Service ID:", serviceId, "Quantity:", quantity);
...
//                         resolve();
//                     } else {
//                         reject(new Error("Failed to create service rental"));
//                     }
//                 });
//             });
//         }
...
//     const promises = Array.from(timelineRows).map(row => {
...
//         console.log("Timeline:", timeline, "Description:", description);
...
//                         resolve();
//                     } else {
//                         reject(new Error("Failed to create timeline"));
//                     }
//                 });
//             });
//         }
...
//     console.log("Device rental data gửi lên server:", data); // Log dữ liệu gửi lên
//     var options = {
//         method: 'POST',
//         headers: {
//             "Content-Type": "application/json",
...
//                     throw new Error(`Lỗi khi tạo device rental: ${response.status} - ${text}`);
//                 });
//             }
//             return response.json();
//         })
//         .then(data => {
//             console.log("Device rental response:", data); // Log phản hồi từ server
//             callback(data);
//         })
//         .catch(error => {
//             console.error("Lỗi khi tạo device rental:", error.message);
//             callback(null);
//         });
// }

// function createServiceRental(data, callback) {
//     console.log("Service rental data gửi lên server:", data); // Log dữ liệu gửi lên
//     var options = {
//         method: 'POST',
//         headers: {
//             "Content-Type": "application/json",
...
//             if (!response.ok) {
//                 return response.text().then(text => {
//                     throw new Error(`Lỗi khi tạo service rental: ${response.status} - ${text}`);
//                 });
//             }
//             return response.json();
//         })
//         .then(data => {
//             console.log("Service rental response:", data); // Log phản hồi từ server
//             callback(data);
//         })
//         .catch(error => {
//             console.error("Lỗi khi tạo service rental:", error.message);
//             callback(null);
//         });
// }

// function createTimeline(data, callback) {
//     console.log("Timeline data gửi lên server:", data); // Log dữ liệu gửi lên
//     var options = {
//         method: 'POST',
//         headers: {
//             "Content-Type": "application/json",
...
//             if (!response.ok) {
//                 return response.text().then(text => {
//                     throw new Error(`Lỗi khi tạo timeline: ${response.status} - ${text}`);
//                 });
//             }
//             return response.json();
//         })
//         .then(data => {
//             console.log("Timeline response:", data); // Log phản hồi từ server
//             callback(data);
//         })
//         .catch(error => {
//             console.error("Lỗi khi tạo timeline:", error.message);
//             callback(null);
//         });
// }
//____________
